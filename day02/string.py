...
# print(f"string in title case : {name.title()}")
# print(f"string in capitalized case : {name.capitalize()}")
# print(f"string in swapcase : {name.swapcase()}")
# print(f"string in casefold : {name.casefold()}")
# print(f"string in isupper : {name.isupper()}")
# print(f"string in islower : {name.islower()}")
# print(f"string in istitle : {name.istitle()}")
# print(f"string in isspace : {name.isspace()}")
